...
export default function Profile() {
    const { isLoggedIn, user, setUser, team, setTeam, getUserTeam, getUserById } = useContext(AuthContext);
    ...
    return (
        <div className='w-screen min-h-screen relative'>
            ...
            <div className="h-screen w-screen flex justify-center items-center">
                <div className="bg-[#030925] bg-opacity-80 h-[80vh] w-[80vw] rounded-3xl m-auto mt-14 absolute">
                    ...
                    <div className="flex text-white justify-center w-full">
                        {team && user.rollNo == team.leaderRollNo && <Button onClick={() => handleDeleteTeam()} className=' bottom-4 content-center bg-blue-700 hover:bg-blue-800 rounded-xl'>{loading1 ? 'Deleting...' : "Delete team"}</Button>}
