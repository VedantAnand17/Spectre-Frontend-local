    ...
    return (
        <div className="bg-[#1E4751] min-h-screen flex justify-center items-center">
            <div className="h-[90vh] m-auto w-[90vw] rounded-3xl ">
                ...
                />
                <img src="https://cdn.discordapp.com/attachments/1314526467144814635/1324343797273985034/WhatsApp_Image_2024-12-16_at_19.56.38_b381d835-removebg-preview_5.png?ex=6777cec6&is=67767d46&hm=f30fa15fe7f027bcc9a4c30ea8553b0978ebaf1d15cca5ae1b8b5aaf0286707a&" alt="" className="absolute ml-6 max-md:h-14" />
