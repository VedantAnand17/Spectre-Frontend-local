...
export default function Landing() {
    ...
    return (
        <div className='max-w-screen'>
            ...
            <div className="h-screen max-w-screen absolute flex max-lg:justify-center">
            ...
            <div className="h-screen max-w-screen absolute text-white">
                <div className="flex lg:gap-60 lg:justify-around items-center h-screen text-xl max-lg:flex-col max-lg:justify-end ">
                    <div className="max-lg:flex-col gap-60 justify-around lg:min-w-screen flex ml-8 max-lg:gap-10 pb-4 items-center">
