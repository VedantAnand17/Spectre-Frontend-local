...
export default function Card() {
    ...
    return (
        <div className="h-screen m-auto w-[100vw] rounded-3xl ">
            {/* <div className="h-[90vh] ml-[7rem] content-center w-[90vw] rounded-3xl z-50 container m-auto flex justify-around max-md:flex-col text-8xl text-white absolute"> */}
            {/* <div className="flex flex-col justify-center items-center">
                    <div className=" rounded-3xl">
                        <HyperText duration={1400} className="text-8xl font-bold md:mb-16 underline backdrop-blur-sm rounded-xl max-md:text-6xl max-md:mt-28 ">Spectre</HyperText>
            ...
            <div className="h-[90vh] w-screen text-white flex flex-col items-center absolute rounded-3xl justify-center gap-5 bg-opacity-80">
                <div className="flex backdrop-blur-sm py-2 px-1 flex-col items-center rounded-3xl justify-center gap-10 bg-opacity-80  max-md:opacity-80 max-md:p-5 max-sm:p-2 ">
                    ...
                    <form className="w-80 gap-6 max-md:gap-2 flex flex-col font-semibold" onSubmit={handleSubmit}>
                        <Input type="text" id="username" placeholder="Name" value={formData.username} onChange={handleChange} className="rounded-xl max-md:py-5 py-6" />
                        {/* <Input
                            type="number"
                            id="phoneNumber"
